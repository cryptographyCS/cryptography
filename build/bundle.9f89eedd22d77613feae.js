  ...
  _createClass(Login, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'form',
          { className: 'login', onSubmit: this.submitForm },
          _react2.default.createElement('input', { id: 'username', value: this.state.user, onChange: this.handleUser.bind(this), type: 'text', placeholder: 'username' }),
          _react2.default.createElement('input', { id: 'password', value: this.state.password, onChange: this.handlePassword.bind(this), type: 'password', placeholder: 'password' }),
          _react2.default.createElement(
            _reactRouterDom.Link,
            { to: '/portfolio' },
            _react2.default.createElement(
