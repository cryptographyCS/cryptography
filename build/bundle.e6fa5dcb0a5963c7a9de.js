  ...
  _createClass(Login, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { className: 'login' },
        _react2.default.createElement('input', { value: this.state.user, onChange: this.handleUser.bind(this), type: 'text' }),
        _react2.default.createElement('input', { value: this.state.password, onChange: this.handlePassword.bind(this), type: 'password' }),
        _react2.default.createElement(
          'button',
          null,
          _react2.default.createElement(
